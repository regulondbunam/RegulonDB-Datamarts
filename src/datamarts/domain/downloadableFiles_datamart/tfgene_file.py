...
def remove_simmilar_items(lista):
    resultado = []
    omitir = set()
    for cadena in lista:
        inicio = cadena[:-1]
...
def find_dual_items(list):
    ...
    return remove_simmilar_items(new_list)
...
def get_all_rows():
    ...
    # TODO: Revisar que hacer con el elemento [RDBECOLITFC00080	GlaR	glaR	RDBECOLIGNC01913	yehE	-	S]
    tfs_content = find_dual_items(sorted(remove_simmilar_items(tfs_content)))
